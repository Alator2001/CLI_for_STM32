...
int process_command( const char * const commandInput, char * writeBuffer, size_t writeBufferLen  )
{
	...
	{
		strncpy( writeBuffer, "Incorrect command parameter(s).  Enter \"help\" to view a list of available commands.\r\n\r\n", writeBufferLen );
		command = NULL;
	}
	...
	{
		strncpy( writeBuffer, "Command not recognised.  Enter 'help' to view a list of available commands.\r\n\r\n", writeBufferLen );
		returnFlag = false;
	}
